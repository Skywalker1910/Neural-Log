...
over it all. Foundation (R1), Home and Today (R2), Training (R3) and Nutrition +
Lifestyle (R4) are done; Learning (R5) is next. Deployment comes last, once the
product is complete - see [docs/ROADMAP.md](docs/ROADMAP.md).
